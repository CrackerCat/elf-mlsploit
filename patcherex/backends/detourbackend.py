...
class DetourBackend(Backend):
    ...
    def __init__(self, filename, data_fallback=None,try_pdf_removal=True,custom_base_addr=None):

        super(DetourBackend, self).__init__(filename,try_pdf_removal,custom_base_addr)
    ...
    def remove_stackable_patches(self, patches):
    ...
    def check_if_movable(instruction):        
        ...
        print "Detourbackend: check_if_movable"
